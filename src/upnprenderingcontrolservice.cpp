...
RenderingControlService::RenderingControlService(IRenderingControl& rc)
: DeviceService(ServiceType::RenderingControl)
, m_renderingControl(rc)
{
}

ActionResponse RenderingControlService::onAction(const std::string& action, const xml::Document& request)
{
